...
//WRITE YOUR CODE BELOW
let isSold = false
let currentOwner = "Jane Doe"
let listing1 = {...listing0, isSold, currentOwner}
 ...
 * Realtor gets 2.5% of the listing price if the listing is equal or below $450,000
...
let realtorFees = (listing => {
    let priceStrip = listing.price.replace(/["$,]/g, "") //To remove the $ and ,
    let price = parseInt(priceStrip) //Turn into int

    let percent = (price < 450000)? 2.5 : 2;
    console.log(price)
    console.log(percent)
...
const newBuiltListings = listings.filter((house) => house.propertySummary.builtIn >= "1990");
